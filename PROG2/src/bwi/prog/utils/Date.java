...
public class Date implements java.lang.Comparable<Date>{
	...
	/**
	 * 
	 * @return the number ending of a number
	 */
	...
	/**
	 *  returns the Julian Day Number for this Date (for formulas see
	 * http://en.wikipedia.org/wiki/Julian_day)
	 * 
	 */
	...
	/**
	 * returns the Lilian Date Number for this Date for details see
